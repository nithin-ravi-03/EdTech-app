  ...
  const [enrolledCourses, setEnrolledCourses] = useState([
    {
      ...
      chapters: [
        { id: 1, title: "Introduction to Advanced JavaScript", completed: true },
        { id: 2, title: "Asynchronous JavaScript", completed: true },
        { id: 3, title: "Closures and Scopes", completed: false },
      ],
      finalExam: { passed: false },
    },
    {
      id: 2,
              ...
              <div>
                ...
                {certificates.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <button className="btn btn-primary">Complete a Course</button>
                  </div>
                )}
              </div>
            )}
