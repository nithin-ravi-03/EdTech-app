...
const JavaScriptInDepth = () => {
  ...
  const handleNextLesson = () => {
    if (currentLesson < javascriptInDepth.lessons.length - 1) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="bg-white rounded-xl shadow-md p-8 max-w-md text-center">
          ...
          {/* Certificate and Sponsorship Eligibility */}
          {totalScore >= 70 ? (
            <div>
  ...
  const lesson = javascriptInDepth.lessons[currentLesson];
    ...
    <div className="py-12 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <button
          ...
          className="btn btn-primary"
        >
          {currentLesson < javascriptInDepth.lessons.length - 1 ? 'Next Lesson' : 'Finish Course'}
        </button>
      </div>
    </div>
  );
