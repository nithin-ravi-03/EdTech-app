...
const AdvancedFlutter = () => {
  ...
  const handleNextLesson = () => {
    if (currentLesson < advancedFlutter.lessons.length - 1) {
  ...
  const lesson = advancedFlutter.lessons[currentLesson];
    ...
    <div className="py-12 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <button
          ...
          className="btn btn-primary"
        >
          {currentLesson < advancedFlutter.lessons.length - 1 ? 'Next Lesson' : 'Finish Course'}
        </button>
      </div>
    </div>
  );
