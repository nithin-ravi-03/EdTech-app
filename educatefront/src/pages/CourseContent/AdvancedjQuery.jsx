// src/pages/CourseContent/AdvancedJQuery.jsx
    ...
    <div className="py-12 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-8">
          <h2 className="text-2xl font-bold mb-4">{advancedJQuery.lessons[currentLesson].title}</h2>
          <p className="text-gray-600 mb-4">{advancedJQuery.lessons[currentLesson].content}</p>
          <div className="mb-4">
            {advancedJQuery.lessons[currentLesson].quiz.map((q, index) => (
          ...
          <button onClick={() => handleQuizSubmit(advancedJQuery.lessons[currentLesson].id)} className="btn btn-primary">
            Submit Quiz
          </button>
          {quizResults && quizResults.lessonId === advancedJQuery.lessons[currentLesson].id && (
